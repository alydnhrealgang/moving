...
// WithName adds the name to the delete asset params
func (o *DeleteAssetParams) WithName(name string) *DeleteAssetParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the delete asset params
func (o *DeleteAssetParams) SetName(name string) {
	o.Name = name
}

// WithPath adds the path to the delete asset params
func (o *DeleteAssetParams) WithPath(path string) *DeleteAssetParams {
	o.SetPath(path)
	return o
}

// SetPath adds the path to the delete asset params
func (o *DeleteAssetParams) SetPath(path string) {
	o.Path = path
}
